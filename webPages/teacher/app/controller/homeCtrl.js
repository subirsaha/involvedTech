            ...
            if (response != '') {
                ...
                if (response.status) {
                    ...
                    $scope.graphstudentPerformanceSubjectwise = function (ClassId, GradeTrend, NameofSubject, HeaderColumn3)
                    {
                       ...
                       //  $('#indistudgraph').css({'display':'block'});
                        $('#featuredisabled').css({'display':'none'});
                        if (GradeTrend == 1) {
                            $scope.plotcolor = "#5BD9A4"; //green
                        } else if (GradeTrend == 3) {
                    ...
                    if (response.status) {
                        if (response != '') {
                            ...
                            if ($rootScope.activeChat!='' && $rootScope.activeChat!='undefined') {
                                    ...
                                    //angular.element( document.querySelector( $rootScope.activeChat ) ).addClass('studSelect');
                                     $timeout(function () {
        ...
        ****************************************************************************************************************/
        ...
        $scope.createTaskPopup = function () {
            ...
            $scope.cancelClickPop = function () {
                ...
                //    alert('day2='+day2+'mnth2='+mnth2+'year2='+year2);
                //   flag++;
                //}
                if (fileNum != 0) {
...
eventService.on($scope, 'message', function (event, data) {
    ...
    {
        //myInbox tab active
         $scope.pos=$rootScope.studentIdsList.indexOf(data.StudentId);
        ...
        if ( $scope.pos>= 0) {
            ...
            if ($scope.exstClass) {
                ...
                //not selected
                //angular.element('#unreadMsg'+data.StudentId+data.ClassId).html();
                $scope.studentListInboxResponse();
