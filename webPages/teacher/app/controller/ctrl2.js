postApp.controller('ctrl2', function ($scope, $filter, $http, $compile, $location, $timeout, constantsProvider, loginService, homeService) {
    ...
    ********************************************************************************************************************/
    ...
    $scope.sendMessage = function (ClassId, ClassName, SubjectName) {
        ...
        ///LOADER HIDE
        $(window).scrollTop(0);
        $("#status_right_content12").show();
        $("#preloader_right_content12").show();
        ...
        homeService.studentListResponse(access_token, ClassId, function (response) {
            ...
            if (response.status) {
                ...
                if (response != '') {
                    ...
                    ///LOADER HIDE
                    $(window).scrollTop(0);
                    $("#status_right_content12").hide();
                    $("#preloader_right_content12").hide();
    ...
    *******************************************************************************************************************/
    ...
    $scope.myInbox = function () {
        ...
        $timeout(function () {
            ...
            {
                $scope.studActive = 1;
                console.log("PALA SAALA")
                //RELOAD TEACHER DETAILS API FOR RESET MSG-COUNTER VALUE
                //$scope.teacherDetailsResponse();
        ...
        ****************************************************************************************************************/
        ...
        $scope.createTaskPopup = function () {
            ...
            $scope.setTaskPop = function () {
                ...
                var dueDateToCompare2 = year2 + '-' + mnth2 + '-' + day2 + 'T' + '00:00:00';
                //alert(dueDateToCompare2);
                //if(dueDateToCompare2 >  currentDate2){
                //    var dueDate2 = year2+'-'+mnth2+'-'+day2+'T'+'00:00:00';
                //    $scope.dateErr2 = "";
                //}else if(dueDateToCompare2 == currentDate2){
                ...
                var nextYearAcademic = (todayTime.getFullYear() + 1);
                var prevYearAcademic = (todayTime.getFullYear() - 1);
                console.log("CURRENT MONTH " + monthAcademic);
                if (monthAcademic <= 8) {
                    var academicYearStartDate = prevYearAcademic + '-' + '09' + '-' + '01' + 'T' + '00:00:00';
                    var academicYearEndDate = yearAcademic + '-' + '08' + '-' + '31' + 'T' + '00:00:00';
                } else {
                ...
                if (dateComp < curDate) {
                    ...
                    var dueDate = yyyy + '-' + mm + '-' + dd + 'T' + '00:00:00';
                    $scope.dateErr2 = "";
                }
                console.log(academicYearStartDate + ' ### ' + academicYearEndDate + '###' + dueDateToCompare2);
                console.log(dateStart + '---' + dateEnd + '---' + dateComp);
            ...
            homeService.taskDescriptionResponse(access_token, taskId, function (response) {
                ...
                if (response.status) {
                    if (response != '') {
                        ...
                        alert(SelectedStudentIds+'  @@@@@@  '+studentArr)
                        $scope.isExist = function (id) {
                            return SelectedStudentIds.indexOf(id);
                        }
                        ////////////////////////////////////////////////////////               
